...
public:
	...
	meualoc(int tamanhoMemoria, int politicaMem);//função que alocar um vetor de tamanho tamanhoMemoria
	...
	//ponteiro no começo do bloco, posicao = tamanho do bloco -> cabe ?
